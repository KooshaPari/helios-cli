...
**Implementation command**: `agileplus implement WP06`
...
- **Library research**: `../research/external-library-leverage.md` — Bifrost identified as top-1 leverage swap (25-40K LOC)
