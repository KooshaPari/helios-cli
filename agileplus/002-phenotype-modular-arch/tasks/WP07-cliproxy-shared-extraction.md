...
**Implementation command**: `agileplus implement WP07 --base WP02`
...
- **Library research**: `../research/external-library-leverage.md` — cliproxyapi++ has 3 parallel auth systems that should collapse to **golang.org/x/oauth2** + **markbates/goth** (6-14K LOC saved)
