...
use chrono::Utc;
use helios_app_server_protocol::Account;
use helios_app_server_protocol::AccountLoginCompletedNotification;
use helios_app_server_protocol::AccountUpdatedNotification;
...
use helios_app_server_protocol::ArchiveConversationParams;
use helios_app_server_protocol::ArchiveConversationResponse;
use helios_app_server_protocol::AskForApproval;
use helios_app_server_protocol::AuthMode;
use helios_app_server_protocol::AuthStatusChangeNotification;
use helios_app_server_protocol::CancelLoginAccountParams;
use helios_app_server_protocol::CancelLoginAccountResponse;
use helios_app_server_protocol::CancelLoginAccountStatus;
use helios_app_server_protocol::CancelLoginChatGptResponse;
use helios_app_server_protocol::ClientRequest;
use helios_app_server_protocol::CollaborationModeListParams;
use helios_app_server_protocol::CollaborationModeListResponse;
use helios_app_server_protocol::CommandExecParams;
use helios_app_server_protocol::ConversationGitInfo;
use helios_app_server_protocol::ConversationSummary;
use helios_app_server_protocol::DynamicToolSpec as ApiDynamicToolSpec;
use helios_app_server_protocol::ExecOneOffCommandResponse;
use helios_app_server_protocol::ExperimentalFeature as ApiExperimentalFeature;
...
use helios_app_server_protocol::ExperimentalFeatureStage as ApiExperimentalFeatureStage;
use helios_app_server_protocol::FeedbackUploadParams;
use helios_app_server_protocol::FeedbackUploadResponse;
use helios_app_server_protocol::ForkConversationParams;
use helios_app_server_protocol::ForkConversationResponse;
use helios_app_server_protocol::FuzzyFileSearchParams;
use helios_app_server_protocol::FuzzyFileSearchResponse;
use helios_app_server_protocol::FuzzyFileSearchSessionStartParams;
use helios_app_server_protocol::FuzzyFileSearchSessionStartResponse;
use helios_app_server_protocol::FuzzyFileSearchSessionStopParams;
use helios_app_server_protocol::FuzzyFileSearchSessionStopResponse;
use helios_app_server_protocol::FuzzyFileSearchSessionUpdateParams;
use helios_app_server_protocol::FuzzyFileSearchSessionUpdateResponse;
use helios_app_server_protocol::GetAccountParams;
use helios_app_server_protocol::GetAccountRateLimitsResponse;
use helios_app_server_protocol::GetAccountResponse;
use helios_app_server_protocol::GetAuthStatusParams;
use helios_app_server_protocol::GetAuthStatusResponse;
use helios_app_server_protocol::GetConversationSummaryParams;
use helios_app_server_protocol::GetConversationSummaryResponse;
use helios_app_server_protocol::GetUserAgentResponse;
use helios_app_server_protocol::GetUserSavedConfigResponse;
use helios_app_server_protocol::GitDiffToRemoteResponse;
use helios_app_server_protocol::GitInfo as ApiGitInfo;
use helios_app_server_protocol::HazelnutScope as ApiHazelnutScope;
use helios_app_server_protocol::InputItem as WireInputItem;
...
use helios_app_server_protocol::ListMcpServerStatusParams;
use helios_app_server_protocol::ListMcpServerStatusResponse;
use helios_app_server_protocol::LoginAccountParams;
use helios_app_server_protocol::LoginAccountResponse;
use helios_app_server_protocol::LoginApiKeyParams;
use helios_app_server_protocol::LoginApiKeyResponse;
use helios_app_server_protocol::LoginChatGptCompleteNotification;
use helios_app_server_protocol::LoginChatGptResponse;
use helios_app_server_protocol::LogoutAccountResponse;
use helios_app_server_protocol::LogoutChatGptResponse;
use helios_app_server_protocol::McpServerOauthLoginCompletedNotification;
use helios_app_server_protocol::McpServerOauthLoginParams;
use helios_app_server_protocol::McpServerOauthLoginResponse;
use helios_app_server_protocol::McpServerRefreshResponse;
use helios_app_server_protocol::McpServerStatus;
use helios_app_server_protocol::MockExperimentalMethodParams;
use helios_app_server_protocol::MockExperimentalMethodResponse;
...
use helios_app_server_protocol::ProductSurface as ApiProductSurface;
use helios_app_server_protocol::RemoveConversationListenerParams;
use helios_app_server_protocol::RemoveConversationSubscriptionResponse;
use helios_app_server_protocol::ResumeConversationParams;
use helios_app_server_protocol::ResumeConversationResponse;
use helios_app_server_protocol::ReviewDelivery as ApiReviewDelivery;
use helios_app_server_protocol::ReviewStartParams;
use helios_app_server_protocol::ReviewStartResponse;
use helios_app_server_protocol::ReviewTarget as ApiReviewTarget;
use helios_app_server_protocol::SandboxMode;
...
use helios_app_server_protocol::SkillsConfigWriteParams;
use helios_app_server_protocol::SkillsConfigWriteResponse;
use helios_app_server_protocol::SkillsListParams;
use helios_app_server_protocol::SkillsListResponse;
use helios_app_server_protocol::SkillsRemoteReadParams;
use helios_app_server_protocol::SkillsRemoteReadResponse;
use helios_app_server_protocol::SkillsRemoteWriteParams;
use helios_app_server_protocol::SkillsRemoteWriteResponse;
use helios_app_server_protocol::Thread;
use helios_app_server_protocol::ThreadArchiveParams;
use helios_app_server_protocol::ThreadArchiveResponse;
use helios_app_server_protocol::ThreadArchivedNotification;
use helios_app_server_protocol::ThreadBackgroundTerminalsCleanParams;
use helios_app_server_protocol::ThreadBackgroundTerminalsCleanResponse;
use helios_app_server_protocol::ThreadCompactStartParams;
use helios_app_server_protocol::ThreadCompactStartResponse;
...
use helios_app_server_protocol::ThreadUnarchiveParams;
use helios_app_server_protocol::ThreadUnarchiveResponse;
use helios_app_server_protocol::ThreadUnarchivedNotification;
...
use helios_app_server_protocol::UserInfoResponse;
use helios_app_server_protocol::UserInput as V2UserInput;
use helios_app_server_protocol::UserSavedConfig;
use helios_app_server_protocol::WindowsSandboxSetupCompletedNotification;
use helios_app_server_protocol::WindowsSandboxSetupMode;
use helios_app_server_protocol::WindowsSandboxSetupStartParams;
use helios_app_server_protocol::WindowsSandboxSetupStartResponse;
use helios_app_server_protocol::build_turns_from_rollout_items;
...
use helios_core::Cursor as RolloutCursor;
use helios_core::NewThread;
use helios_core::RolloutRecorder;
use helios_core::SessionMeta;
use helios_core::SteerInputError;
use helios_core::ThreadConfigSnapshot;
use helios_core::ThreadManager;
use helios_core::ThreadSortKey as CoreThreadSortKey;
use helios_core::auth::AuthMode as CoreAuthMode;
use helios_core::auth::CLIENT_ID;
use helios_core::auth::login_with_api_key;
use helios_core::auth::login_with_chatgpt_auth_tokens;
use helios_core::config::Config;
use helios_core::config::ConfigOverrides;
use helios_core::config::ConfigService;
use helios_core::config::edit::ConfigEdit;
...
use helios_core::find_archived_thread_path_by_id_str;
use helios_core::find_thread_name_by_id;
use helios_core::find_thread_names_by_ids;
use helios_core::find_thread_path_by_id_str;
use helios_core::git_info::git_diff_to_remote;
use helios_core::mcp::collect_mcp_snapshot;
use helios_core::mcp::group_tools_by_server;
use helios_core::parse_cursor;
use helios_core::read_head_for_summary;
use helios_core::read_session_meta_line;
use helios_core::rollout_date_parts;
use helios_core::sandboxing::SandboxPermissions;
use helios_core::skills::remote::export_remote_skill;
use helios_core::skills::remote::list_remote_skills;
use helios_core::state_db::StateDbHandle;
use helios_core::state_db::get_state_db;
use helios_core::windows_sandbox::WindowsSandboxLevelExt;
use helios_core::windows_sandbox::WindowsSandboxSetupMode as CoreWindowsSandboxSetupMode;
use helios_core::windows_sandbox::WindowsSandboxSetupRequest;
use helios_feedback::CodexFeedback;
use helios_login::ServerOptions as LoginServerOptions;
...
use helios_protocol::dynamic_tools::DynamicToolSpec as CoreDynamicToolSpec;
...
use helios_protocol::protocol::McpAuthStatus as CoreMcpAuthStatus;
...
use helios_protocol::protocol::ReviewDelivery as CoreReviewDelivery;
use helios_protocol::protocol::ReviewRequest;
use helios_protocol::protocol::ReviewTarget as CoreReviewTarget;
...
use helios_protocol::protocol::USER_MESSAGE_BEGIN;
use helios_protocol::user_input::UserInput as CoreInputItem;
use helios_rmcp_client::perform_oauth_login_return_url;
...
impl CodexMessageProcessor {
    ...
    async fn load_latest_config(&self) -> Result<Config, JSONRPCErrorError> {
        ...
        helios_core::config::ConfigBuilder::default()
    ...
    fn review_request_from_target(
        ...
        let hint = helios_core::review_prompts::user_facing_hint(&core_target);
    ...
    async fn login_api_key_v2(
        ...
        match self.login_api_key_common(&params).await {
            Ok(()) => {
                let response = helios_app_server_protocol::LoginAccountResponse::ApiKey {};
        ...
        match self.login_chatgpt_common().await {
            Ok(opts) => match run_login_server(opts) {
                Ok(server) => {
                    ...
                    let response = helios_app_server_protocol::LoginAccountResponse::Chatgpt {
    ...
    async fn get_user_saved_config(&self, request_id: ConnectionRequestId) {
        let service = ConfigService::new_with_defaults(self.config.helios_home.clone());
    ...
    async fn set_default_model(
        ...
        match ConfigEditsBuilder::new(&self.config.helios_home)
    ...
    async fn exec_one_off_command(
        ...
        let helios_linux_sandbox_exe = self.config.helios_linux_sandbox_exe.clone();
        let outgoing = self.outgoing.clone();
        ...
        tokio::spawn(async move {
            ...
            match helios_core::exec::process_exec_tool_call(
                exec_params,
                &effective_policy,
                sandbox_cwd.as_path(),
                &helios_linux_sandbox_exe,
    ...
    fn build_thread_config_overrides(
        ...
        cwd: Option<String>,
        approval_policy: Option<helios_app_server_protocol::AskForApproval>,
        ...
        ConfigOverrides {
            ...
            approval_policy: approval_policy
                .map(helios_app_server_protocol::AskForApproval::to_core),
    ...
    async fn thread_archive(
        ...
        let rollout_path =
            match find_thread_path_by_id_str(&self.config.helios_home, &thread_id.to_string()).await
            {
                Ok(Some(p)) => p,
                Ok(None) => {
                    let error = JSONRPCErrorError {
    ...
    async fn thread_unarchive(
        ...
        let archived_folder = self
            .config
            .helios_home
            .join(helios_core::ARCHIVED_SESSIONS_SUBDIR);
        ...
        let result: Result<Thread, JSONRPCErrorError> = async {
            ...
            let sessions_folder = self.config.helios_home.join(helios_core::SESSIONS_SUBDIR);
    ...
    async fn thread_list(&self, request_id: ConnectionRequestId, params: ThreadListParams) {
        ...
        let names = match find_thread_names_by_ids(&self.config.helios_home, &thread_ids).await {
            Ok(names) => names,
            Err(err) => {
    ...
    async fn thread_read(&mut self, request_id: ConnectionRequestId, params: ThreadReadParams) {
        ...
        if rollout_path.is_none() || include_turns {
            rollout_path =
                match find_thread_path_by_id_str(&self.config.helios_home, &thread_uuid.to_string())
                    .await
                {
    ...
    async fn attach_thread_name(&self, thread_id: ThreadId, thread: &mut Thread) {
        match find_thread_name_by_id(&self.config.helios_home, &thread_id).await {
            Ok(name) => {
                thread.name = name;
            }
            Err(err) => {
        ...
        let path = match params {
            GetConversationSummaryParams::RolloutPath { rollout_path } => {
                if rollout_path.is_relative() {
                    self.config.helios_home.join(&rollout_path)
                } else {
                    rollout_path
                }
            }
            GetConversationSummaryParams::ThreadId { conversation_id } => {
                match helios_core::find_thread_path_by_id_str(
                    &self.config.helios_home,
    ...
    async fn handle_resume_conversation(
        ...
        let thread_history = if let Some(path) = path {
            ...
            match find_thread_path_by_id_str(&self.config.helios_home, &conversation_id.to_string())
                .await
            {
                Ok(Some(found_path)) => {
    ...
    async fn archive_thread_common(
        ...
        let rollout_folder = self.config.helios_home.join(helios_core::SESSIONS_SUBDIR);
    ...
    async fn skills_list(&self, request_id: ConnectionRequestId, params: SkillsListParams) {
        ...
        for cwd in cwds {
            ...
            data.push(helios_app_server_protocol::SkillsListEntry {
                cwd,
                skills,
                errors,
            });
    ...
    async fn skills_remote_list(
        ...
        .await
        {
            Ok(skills) => {
                let data = skills
                    .into_iter()
                    .map(|skill| helios_app_server_protocol::RemoteSkillSummary {
                        id: skill.id,
                        name: skill.name,
    ...
    async fn skills_config_write(
        ...
        let result = ConfigEditsBuilder::new(&self.config.helios_home)
            .with_edits(edits)
            .apply()
            .await;
    ...
    async fn start_detached_review(
        ...
        let rollout_path = if let Some(path) = parent_thread.rollout_path() {
            ...
            find_thread_path_by_id_str(&self.config.helios_home, &parent_thread_id.to_string())
                .await
                .map_err(|err| JSONRPCErrorError {
                    code: INTERNAL_ERROR_CODE,
    ...
    async fn windows_sandbox_setup_start(
        ...
        tokio::spawn(async move {
            ...
            let setup_result =
                helios_core::windows_sandbox::run_windows_sandbox_setup(setup_request).await;
...
fn skills_to_info(
    skills: &[helios_core::skills::SkillMetadata],
    disabled_paths: &std::collections::HashSet<PathBuf>,
) -> Vec<helios_app_server_protocol::SkillMetadata> {
    skills
        .iter()
        .map(|skill| {
            let enabled = !disabled_paths.contains(&skill.path);
            helios_app_server_protocol::SkillMetadata {
                name: skill.name.clone(),
                description: skill.description.clone(),
                short_description: skill.short_description.clone(),
                interface: skill.interface.clone().map(|interface| {
                    helios_app_server_protocol::SkillInterface {
                ...
                dependencies: skill.dependencies.clone().map(|dependencies| {
                    helios_app_server_protocol::SkillDependencies {
                        tools: dependencies
                            .tools
                            .into_iter()
                            .map(|tool| helios_app_server_protocol::SkillToolDependency {
                                r#type: tool.r#type,
                                value: tool.value,
                                description: tool.description,
...
fn errors_to_info(
    errors: &[helios_core::skills::SkillError],
) -> Vec<helios_app_server_protocol::SkillErrorInfo> {
    errors
        .iter()
        .map(|err| helios_app_server_protocol::SkillErrorInfo {
            path: err.path.clone(),
...
fn validate_dynamic_tools(tools: &[ApiDynamicToolSpec]) -> Result<(), String> {
    ...
    for tool in tools {
        ...
        if let Err(err) = helios_core::parse_tool_input_schema(&tool.input_schema) {
            return Err(format!(
...
fn replace_cloud_requirements_loader(
    ...
    let loader = cloud_requirements_loader(auth_manager, chatgpt_base_url, helios_home);
...
async fn sync_default_client_residency_requirement(
    ...
    let loader = cloud_requirements
        ...
        .map(|guard| guard.clone())
        .unwrap_or_default();
    match helios_core::config::ConfigBuilder::default()
...
async fn summary_from_thread_list_item(
    ...
    if let Some(thread_id) = it.thread_id {
        ...
        let source = with_thread_spawn_agent_metadata(
            it.source
                .unwrap_or(helios_protocol::protocol::SessionSource::Unknown),
...
fn extract_conversation_summary(
    ...
    let preview = head
        ...
        .find_map(|item| match helios_core::parse_turn_item(&item) {
...
fn with_thread_spawn_agent_metadata(
    source: helios_protocol::protocol::SessionSource,
    agent_nickname: Option<String>,
    agent_role: Option<String>,
) -> helios_protocol::protocol::SessionSource {
    if agent_nickname.is_none() && agent_role.is_none() {
        return source;
    }

    match source {
        helios_protocol::protocol::SessionSource::SubAgent(
            helios_protocol::protocol::SubAgentSource::ThreadSpawn {
                parent_thread_id,
                depth,
