...
use helios_app_server_protocol::ThreadActiveFlag;
use helios_app_server_protocol::ThreadStatus;
use helios_app_server_protocol::ThreadStatusChangedNotification;
...
mod tests {
    ...
    async fn tracks_non_interactive_thread_status() {
        ...
        manager
            .upsert_thread(test_thread(
                ...
                helios_app_server_protocol::SessionSource::AppServer,
            ))
            .await;
    ...
    async fn status_updates_track_single_thread() {
        ...
        manager
            .upsert_thread(test_thread(
                ...
                helios_app_server_protocol::SessionSource::Cli,
            ))
            .await;
    ...
    fn test_thread(thread_id: &str, source: helios_app_server_protocol::SessionSource) -> Thread {
        Thread {
