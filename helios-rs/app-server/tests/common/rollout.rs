...
pub fn rollout_path(helios_home: &Path, filename_ts: &str, thread_id: &str) -> PathBuf {
...
/// Create a minimal rollout file under `HELIOS_HOME/sessions/YYYY/MM/DD/`.
///
...
pub fn create_fake_rollout_with_source(
    ...
    let file_path = rollout_path(helios_home, filename_ts, &uuid_str);
    let dir = file_path
        .parent()
