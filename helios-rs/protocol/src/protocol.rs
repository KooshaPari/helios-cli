...
pub enum Op {
    ...
    /// for a turn of a [`crate::helios_thread::CodexThread`].
    UserTurn {
        /// User input items, see `InputItem`
        items: Vec<UserInput>,
    ...
    /// This is a local-only operation handled by helios-core; it does not
    /// involve the model.
    ...
    fn serialize_event() -> Result<()> {
        ...
        let event = Event {
            ...
            msg: EventMsg::SessionConfigured(SessionConfiguredEvent {
                ...
                forked_from_id: None,
                thread_name: None,
                model: "helios-mini-latest".to_string(),
