//! Shared model metadata types exchanged between Helios services and clients.
//!
...
/// Metadata describing a Helios-supported model.
#[derive(Debug, Clone, Deserialize, Serialize, TS, JsonSchema, PartialEq)]
...
/// Model metadata returned by the Helios backend `/models` endpoint.
