...
pub(crate) const ZSH_EXEC_BRIDGE_WRAPPER_SOCKET_ENV_VAR: &str =
    "HELIOS_ZSH_EXEC_BRIDGE_WRAPPER_SOCKET";
pub(crate) const ZSH_EXEC_WRAPPER_MODE_ENV_VAR: &str = "HELIOS_ZSH_EXEC_WRAPPER_MODE";
#[cfg(unix)]
...
impl ZshExecBridge {
    pub(crate) fn new(zsh_path: Option<PathBuf>, _helios_home: PathBuf) -> Self {
        Self {
            zsh_path,
