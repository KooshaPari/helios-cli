...
use helios_api::endpoint::realtime_websocket::RealtimeWebsocketEvents;
use helios_api::endpoint::realtime_websocket::RealtimeWebsocketWriter;
...
async fn send_conversation_error(
    ...
    sub_id: String,
    message: String,
    helios_error_info: CodexErrorInfo,
) {
    sess.send_event_raw(Event {
        id: sub_id,
