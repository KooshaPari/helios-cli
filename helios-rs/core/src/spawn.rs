...
pub const HELIOS_SANDBOX_NETWORK_DISABLED_ENV_VAR: &str = "HELIOS_SANDBOX_NETWORK_DISABLED";
...
pub const HELIOS_SANDBOX_ENV_VAR: &str = "HELIOS_SANDBOX";
...
/// `HELIOS_SANDBOX_NETWORK_DISABLED_ENV_VAR` environment variable.
    ...
    unsafe {
        ...
        cmd.pre_exec(move || {
            ...
            #[cfg(target_os = "linux")]
            {
                ...
                // current parent dies."
                helios_utils_pty::process_group::set_parent_death_signal(parent_pid)?;
            }
            Ok(())
        });
    }
