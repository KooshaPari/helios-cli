...
mod tests {
    ...
    fn prompt_snapshot_gpt5_codex() {
        ...
        let screen = ModelMigrationScreen::new(
            ...
            migration_copy_for_models(
                "gpt-5-codex",
                "gpt-5.1-helios-max",
                Some("https://www.codex.com/models/gpt-5.1-helios-max".to_string()),
                None,
                None,
                "gpt-5.1-helios-max".to_string(),
                Some("Helios-optimized flagship for deep and fast reasoning.".to_string()),
    ...
    #[test]
    fn prompt_snapshot_gpt5_helios_mini() {
        let backend = VT100Backend::new(60, 22);
        let mut terminal = Terminal::with_options(backend).expect("terminal");
        terminal.set_viewport_area(Rect::new(0, 0, 60, 22));
        ...
        let screen = ModelMigrationScreen::new(
            ...
            migration_copy_for_models(
                "gpt-5-helios-mini",
                "gpt-5.1-helios-mini",
                Some("https://www.codex.com/models/gpt-5.1-helios-mini".to_string()),
                None,
                None,
                "gpt-5.1-helios-mini".to_string(),
