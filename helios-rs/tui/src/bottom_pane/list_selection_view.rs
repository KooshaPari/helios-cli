...
mod tests {
    ...
    fn make_selection_view(subtitle: Option<&str>) -> ListSelectionView {
        ...
        let items = vec![
            SelectionItem {
                ...
                description: Some("Helios can read files".to_string()),
                is_current: true,
            ...
            SelectionItem {
                ...
                description: Some("Helios can edit files".to_string()),
                is_current: false,
                dismiss_on_select: true,
                ..Default::default()
            },
    ...
    fn renders_blank_line_between_subtitle_and_items() {
        let view = make_selection_view(Some("Switch between Helios approval presets"));
    ...
    fn theme_picker_subtitle_uses_fallback_text_in_94x35_terminal() {
        ...
        let params =
            crate::theme_picker::build_theme_picker_params(None, Some(&helios_home), Some(94));
    ...
    fn width_changes_do_not_hide_rows() {
        ...
        let items = vec![
            SelectionItem {
                ...
                description: Some(
                    "Optimized for Helios. Balance of reasoning quality and coding ability."
                        .to_string(),
                ),
                is_current: true,
                dismiss_on_select: true,
            ...
            SelectionItem {
                name: "gpt-5.1-helios-mini".to_string(),
                description: Some(
                    "Optimized for Helios. Cheaper, faster, but less capable.".to_string(),
                ),
                dismiss_on_select: true,
                ..Default::default()
            },
